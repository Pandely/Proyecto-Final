var Calculadora={
	...
	iniciar:function(){
		...
		if(alt!="punto" && alt!="signo" && alt!="mas"
	    && alt!="igual" && alt!="menos" && alt!="por"
	    && alt!="dividido" && alt!="raiz"){
			Calculadora.IngresarNumero(alt);
